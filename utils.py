...
def build_clipin_before(clothing_en="", match_identity=True):
    ...
    return (
        ...
        f"remove every single colored strand (e.g. remove blue/green/pink extensions). Keep her OWN natural "
        f"hair color exactly as in the FIRST image (if it is dark brown keep it dark brown, if blonde keep "
        f"blonde — match the first image, do NOT lighten, darken or change it). "
        f"{clothing_override}"
