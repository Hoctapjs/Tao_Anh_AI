...
def build_clipin_before(clothing_en="", match_identity=True):
    ...
    return (
        ...
        f"CRITICAL — KEEP HER ORIGINAL HAIR COLOR/SHADE: use the model's OWN predominant natural hair shade "
        f"as shown in the photo and apply that SAME shade evenly everywhere. If her hair is light "
        f"blonde/ash/silver, the whole hair stays that same LIGHT blonde tone; if it is brown, keep that "
        f"brown. DO NOT darken her hair, DO NOT turn it dark brown or black, DO NOT change how light or dark "
        f"it is — only even out the tone and remove the highlights/ombre. Match the overall lightness of her "
        f"original hair exactly. The before hair looks like plain, untreated, single-color natural hair in "
        f"HER OWN color, with NO highlights and NO gradient. This is mandatory.\n"
