...
def build_clipin_studio(color_name, hex_color):
    ...
    return (
        "Keep everything from the first image exactly the same (the same woman, her face, skin, hair color "
        "and colored highlight strands, outfit and background), but adjust her pose to match the pose in the "
        "second image."
    )
